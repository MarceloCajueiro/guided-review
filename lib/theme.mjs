...
.ch { margin-bottom: calc(var(--u) * 12); scroll-margin-top: 76px; }
...
/* A beat is one unit of narrative: prose on the left, its code on the right.
   Below 1180px the two stack — the prose stays above the code it describes,
...
.code .k { color: light-dark(oklch(46% 0.135 300), oklch(78% 0.105 305)); }
.code .s { color: light-dark(oklch(44% 0.105 150), oklch(76% 0.088 152)); }
.code .c { color: var(--ink-3); font-style: italic; }
.code .n { color: light-dark(oklch(48% 0.115 40),  oklch(78% 0.088 48)); }
.code .t { color: light-dark(oklch(45% 0.110 235), oklch(76% 0.085 238)); }
.code .a { color: light-dark(oklch(46% 0.105 265), oklch(75% 0.080 268)); }
.code .v { color: light-dark(oklch(47% 0.110 20),  oklch(77% 0.085 24)); }
